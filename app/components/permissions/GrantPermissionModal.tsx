...
export function GrantPermissionsModal({ isOpen, onClose, allData, canSelectGroups = true, canSelectCategories = true, canSelectBoards = true }: GrantPermissionsModalProps) {
