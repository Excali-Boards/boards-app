...
export const Excalidraw = memo(loadable(() => import('@excalidraw/excalidraw'), {
	resolveComponent: (module) => module.Excalidraw,
	ssr: false,
}));

export const Tldraw = memo(loadable(() => import('tldraw'), {
	resolveComponent: (module) => module.Tldraw,
	ssr: false,
}));
